...
nums1 = ['1','3','2','0','4','7','9','6','5','8']


comnums2 = ['17','12','13','33','23','11','21','16','18']
comnums3 = ['123','333','777','111','007','321','666','456','789']
comnums4 = ['1234','4321','1111','2222','3333','1776','1920','1942','1969','2000','1999','2020']
...
pass7 = open('done/wifi12025.txt', "w")

pass8 = open('done/lower4-14plus4nums.txt', "w")
# pass9 = open('done/lower94nums.txt', "w")
...
def string_to_list(strlist):
    # take string of words into list
...
def floodvars(wls):
	...
	for each in wls.readlines():
		each1 = clean_string(each)
		for each2 in string_to_list(each1):
			each = each2.rstrip('\n\t\r')
			if len(each) == 1:
		  	  let1a.append(each)
			elif len(each) == 2:
...
myfiles = []
for each_file in glob.glob("2025/*.txt"):
	numba = 0
...
def seqvarslower10():
	...
	for each in range(len(let5)):
		for each2 in range(len(let5)):
			pass14.write(let5[each] + let5[each2])
			pass14.write("\n")
	for each in range(len(let5)):
		for each2 in range(len(let4)):
			for each3 in range(len(let1)):
				pass14.write(let5[each] + let4[each2] + let1[each3])
				pass14.write("\n")	
	for each in range(len(let5)):
		for each2 in range(len(let1)):
			for each3 in range(len(let4)):
				pass14.write(let5[each] + let1[each2] + let4[each3])
				pass14.write("\n")
	for each in range(len(let4)):
		for each2 in range(len(let1)):
			for each3 in range(len(let5)):
				pass14.write(let4[each] + let1[each2] + let5[each3])
				pass14.write("\n")
	for each in range(len(let4)):
		for each2 in range(len(let5)):
			for each3 in range(len(let1)):
				pass14.write(let4[each] + let5[each2] + let1[each3])
				pass14.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let5)):
			for each3 in range(len(let4)):
				pass14.write(let1[each] + let5[each2] + let4[each3])
				pass14.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let4)):
			for each3 in range(len(let5)):
...
# Sequence Variables WIFI 1 2025 lowercase 8 character
def seqvarsWifi8():
	
	print ('\n')
	print ('Sequencing Variables For WIFI Lowercase 8 Character plus my shit')
	print ('\n')
	# -------------	lowercase 8 --------------------------------------------------------
	for each in range(len(let8)):
		pass7.write(let8[each])
		pass7.write("\n")
	for each in range(len(let8)):
		for each2 in range(len(spec)):
			for each3 in range(len(let1)):
				pass7.write(let6[each] + let1[each2] + let1[each3])
				pass7.write("\n")	
	# -----	lowercase 7-------------------------------------------------------------------
	for each in range(len(let1)):
		for each2 in range(len(let7)):
			pass7.write(let1[each] + let7[each2])
			pass7.write("\n")
	for each in range(len(let7)):
		for each2 in range(len(let1)):
			pass7.write(let7[each] + let1[each2])
			pass7.write("\n")
	# -----	lowercase 6 ----------------------------------------------------------------------
	for each in range(len(let2)):
		for each2 in range(len(let6)):
			pass7.write(let2[each] + let6[each2])
			pass7.write("\n")
	for each in range(len(let6)):
		for each2 in range(len(let2)):
			pass7.write(let6[each] + let2[each2])
			pass7.write("\n")
	for each in range(len(let6)):
		for each2 in range(len(let1)):
			for each3 in range(len(let1)):
	...
	for each in range(len(let1)):
		for each2 in range(len(let1)):
			for each3 in range(len(let6)):
				pass7.write(let1[each] + let1[each2] + let6[each3])
				pass7.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let6)):
			for each3 in range(len(let1)):
				pass7.write(let1[each] + let6[each2] + let1[each3])
				pass7.write("\n")

	# -----	lowercase 5 ------------------------------------------------------------------------------------------
	for each in range(len(let5)):
		for each2 in range(len(let3)):
			pass7.write(let5[each] + let3[each2])
			pass7.write("\n")
	for each in range(len(let3)):
		for each2 in range(len(let5)):
			pass7.write(let3[each] + let5[each2])
			pass7.write("\n")
	...
	for each in range(len(let4)):
		for each2 in range(len(let2)):
			for each3 in range(len(let2)):
				pass7.write(let4[each] + let2[each2] + let2[each3])
				pass7.write("\n")
	for each in range(len(let4)):
		for each2 in range(len(let1)):
			for each3 in range(len(let3)):
				pass7.write(let4[each] + let1[each2] + let3[each3])
				pass7.write("\n")	
	for each in range(len(let3)):
		for each2 in range(len(let1)):
			for each3 in range(len(let4)):
				pass7.write(let3[each] + let1[each2] + let4[each3])
				pass7.write("\n")
	for each in range(len(let2)):
		for each2 in range(len(let4)):
			for each3 in range(len(let2)):
				pass7.write(let2[each] + let4[each2] + let2[each3])
				pass7.write("\n")
	for each in range(len(let2)):
		for each2 in range(len(let2)):
			for each3 in range(len(let4)):
				pass7.write(let2[each] + let2[each2] + let4[each3])
				pass7.write("\n")
	...
	for each in range(len(let2)):
		for each2 in range(len(let3)):
			for each3 in range(len(let3)):
				pass7.write(let2[each] + let3[each2] + let3[each3])
				pass7.write("\n")
	for each in range(len(let3)):
		for each2 in range(len(let2)):
			for each3 in range(len(let3)):
				pass7.write(let3[each] + let2[each2] + let3[each3])
				pass7.write("\n")
	for each in range(len(let3)):
		for each2 in range(len(let3)):
			for each3 in range(len(let2)):
				pass7.write(let3[each] + let3[each2] + let2[each3])
				pass7.write("\n")


	print ('\n')
	print ('Sequence Variables WIFI 1 2025 Character Complete')
	print ('\n')
	#--------------------------------------------------------------------------------------------------------
		
	
	
# Sequence Variables lowercase 4 - 14 plus 4 nums character
def seqvarslower8plus4nums():
	
	print ('\n')
	print ('Sequencing Variables Lowercase 4 - 14 plus 4 nums Character')
	print ('\n')
	
	# Initial list of years as strings
	nums4 = [str(i) for i in range(1880, 2027)]
	
	# Throw in every birthday 4 digit pin haha bitches
	dates = []
	for month in range(1, 13):  # Iterate over months (1 to 12)
		for day in range(1, 32):  # Iterate over days (1 to 31)
			date = f"{month:02d}{day:02d}"
			dates.append(date)	

	# Additional 4-digit numbers as strings
	addnums = ['5150','1492','1517','1588', '1776', '1789', '1815', '1861', '1862', '1863', '1864', '1865']
	
	nums4.extend(addnums)
	nums4.extend(dates)
	
	# --------- lowercase 4 ----------------------------------------------------------------------------------
	for each1 in nums4:
		for each in range(len(let4)):
			pass8.write(let4[each] + str(each1))
			pass8.write("\n")
			pass8.write(str(each1) + let4[each])
			pass8.write("\n")
	# --------- lowercase 5 ----------------------------------------------------------------------------------
	for each1 in nums4:
		for each in range(len(let5)):
			pass8.write(let5[each] + str(each1))
			pass8.write("\n")
			pass8.write(str(each1) + let5[each])
			pass8.write("\n")
	# --------- lowercase 6 ----------------------------------------------------------------------------------
	for each1 in nums4:
		for each in range(len(let6)):
			pass8.write(let6[each] + str(each1))
			pass8.write("\n")
			pass8.write(str(each1) + let6[each])
			pass8.write("\n")			
	# --------- lowercase 7 ----------------------------------------------------------------------------------
	for each1 in nums4:
		for each in range(len(let7)):
			pass8.write(let7[each] + str(each1))
			pass8.write("\n")
			pass8.write(str(each1) + let7[each])
			pass8.write("\n")	
	# --------- lowercase 8 ----------------------------------------------------------------------------------
	for each1 in nums4:
		for each in range(len(let8)):
			pass8.write(let8[each] + str(each1))
			pass8.write("\n")
			pass8.write(str(each1) + let8[each])
			pass8.write("\n")
	# --------- lowercase 9 ----------------------------------------------------------------------------------
	for each1 in nums4:
		for each in range(len(let9)):
			pass8.write(let9[each] + str(each1))
			pass8.write("\n")
			pass8.write(str(each1) + let9[each])
			pass8.write("\n")
	# --------- lowercase 10 ----------------------------------------------------------------------------------
	for each1 in nums4:
		for each in range(len(let10)):
			pass8.write(let10[each] + str(each1))
			pass8.write("\n")
			pass8.write(str(each1) + let10[each])
	# --------- lowercase 11 ----------------------------------------------------------------------------------
	for each1 in nums4:
		for each in range(len(let11)):
			pass8.write(let11[each] + str(each1))
			pass8.write("\n")
			pass8.write(str(each1) + let11[each])
			pass8.write("\n")
	# --------- lowercase 12 ----------------------------------------------------------------------------------
	for each1 in nums4:
		for each in range(len(let12)):
			pass8.write(let12[each] + str(each1))
			pass8.write("\n")
			pass8.write(str(each1) + let12[each])
			pass8.write("\n")
	# --------- lowercase 13 ----------------------------------------------------------------------------------
	for each1 in nums4:
		for each in range(len(let13)):
			pass8.write(let13[each] + str(each1))
			pass8.write("\n")
			pass8.write(str(each1) + let13[each])
			pass8.write("\n")
	# --------- lowercase 14 ----------------------------------------------------------------------------------
	for each1 in nums4:
		for each in range(len(let14)):
			pass8.write(let14[each] + str(each1))
			pass8.write("\n")
			pass8.write(str(each1) + let14[each])
			pass8.write("\n")
			
			
	print ('\n')
	print ('Sequence Variables Lowercase 4 - 14 Character plus 4 nums Complete')
	print ('\n')
	#--------------------------------------------------------------------------------------------------------			
...
# Compile wordlist menu 
def compileWordlist():
	os.system('clear')
	print ('\n')
	print ("                               Compile Wordlists Menu  \n\n\n\n\n")
	print ('\n')
	print ('( Choice : 1) 8 Letter Words ')
	print ('\n')
	print ('( Choice : 2) 8 Letter Words - First letter Cap ')
	print ('\n')
	print ('( Choice : 3) 8 Letter Words - plus numbers')
	print ('\n')
	print ('( Choice : 4) 8 Letter Words - plus special char')
	print ('\n')
	print ('( Choice : 5) 4-14 Letter Words - plus 4 nums')
	print ('\n')
	print ('( Choice : 6) 9 Letter Words ')
	print ('\n')
	print ('( Choice : 7) 9 Letter Words - First letter Cap')
	print ('\n')
	print ('( Choice : 8) 10 Letter Words ')
	print ('\n')
	print ('( Choice : 9) WIFI list 1.txt ')
	print ('\n')	
	print ('( Choice : 10) Compile wordlist Output.txt ')
	print ('\n')	
	print ('( Choice : 11) Compile ALL !!!')
	print ('\n')		
	target=input("Enter your Choice : ")
	if target=="1":
		seqvarslower8()
...
def mainmenu():
	...
	os.system('clear')
	print ('\n')
	print ("                              PWD HAX              December 29th,2025\n\n\n\n\n")
	print ('\n')
	print ('1 Letter Words  = ',len(let1)) 
	print ('2 Letter Words  = ',len(let2))
	print ('3 Letter Words  = ',len(let3))
