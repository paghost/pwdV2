...
pass2 = open('done/2lower8.txt', "w")
pass3 = open('done/3lower8.txt', "w")

pass4 = open('done/1cap8.txt', "w")
pass5 = open('done/2cap8.txt', "w")
pass6 = open('done/3cap8.txt', "w")


pass7 = open('done/1lower9.txt', "w")
pass8 = open('done/2lower9.txt', "w")
pass9 = open('done/3lower9.txt', "w")

pass10 = open('done/1cap9.txt', "w")
pass11 = open('done/2cap9.txt', "w")
pass12 = open('done/3cap9.txt', "w")

pass13 = open('done/1lower10.txt', "w")
pass14 = open('done/2lower10.txt', "w")
pass15 = open('done/3lower10.txt', "w")
pass16 = open('done/4lower10.txt', "w")
...
def seqvarslower10():
	...
	for each in range(len(let10)):
		pass13.write(let10[each])
		pass13.write("\n")	
	# -----	lowercase 9-------------------------------------------------------------------
	for each in range(len(let1)):
		for each2 in range(len(let9)):
			pass13.write(let1[each] + let9[each2])
			pass13.write("\n")
	for each in range(len(let9)):
		for each2 in range(len(let1)):
			pass13.write(let9[each] + let1[each2])
			pass13.write("\n")
	# -----	lowercase 8-------------------------------------------------------------------
	for each in range(len(let2)):
		for each2 in range(len(let8)):
			pass13.write(let2[each] + let8[each2])
			pass13.write("\n")
	for each in range(len(let8)):
		for each2 in range(len(let2)):
			pass13.write(let8[each] + let2[each2])
			pass13.write("\n")
	for each in range(len(let8)):
		for each2 in range(len(let1)):
			for each3 in range(len(let1)):
				pass13.write(let8[each] + let1[each2] + let1[each3])
				pass13.write("\n")	
	for each in range(len(let1)):
		for each2 in range(len(let1)):
			for each3 in range(len(let8)):
				pass13.write(let1[each] + let1[each2] + let8[each3])
				pass13.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let8)):
			for each3 in range(len(let1)):
				pass13.write(let1[each] + let8[each2] + let1[each3])
				pass13.write("\n")
	# -----	lowercase 7-------------------------------------------------------------------
	for each in range(len(let3)):
		for each2 in range(len(let7)):
			pass13.write(let3[each] + let7[each2])
			pass13.write("\n")
	for each in range(len(let7)):
		for each2 in range(len(let3)):
			pass13.write(let7[each] + let3[each2])
			pass13.write("\n")
	for each in range(len(let7)):
		for each2 in range(len(let1)):
			for each3 in range(len(let2)):
				pass13.write(let7[each] + let1[each2] + let2[each3])
				pass13.write("\n")	
	for each in range(len(let2)):
		for each2 in range(len(let1)):
			for each3 in range(len(let7)):
				pass13.write(let2[each] + let1[each2] + let7[each3])
				pass13.write("\n")
	for each in range(len(let7)):
		for each2 in range(len(let2)):
			for each3 in range(len(let1)):
				pass13.write(let7[each] + let2[each2] + let1[each3])
				pass13.write("\n")	
	for each in range(len(let2)):
		for each2 in range(len(let7)):
			for each3 in range(len(let1)):
				pass13.write(let2[each] + let7[each2] + let1[each3])
				pass13.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let2)):
			for each3 in range(len(let7)):
				pass13.write(let1[each] + let2[each2] + let7[each3])
				pass13.write("\n")	
	for each in range(len(let1)):
		for each2 in range(len(let7)):
			for each3 in range(len(let2)):
				pass13.write(let1[each] + let7[each2] + let2[each3])
				pass13.write("\n")
	for each in range(len(let7)):
		for each2 in range(len(let1)):
			for each3 in range(len(let1)):
				for each4 in range(len(let1)):
					pass13.write(let7[each] + let1[each2] + let1[each3] + let1[each4])
					pass13.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let1)):
			for each3 in range(len(let1)):
				for each4 in range(len(let7)):
					pass13.write(let1[each] + let1[each2] + let1[each3] + let7[each4])
					pass13.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let1)):
			for each3 in range(len(let7)):
				for each4 in range(len(let1)):
					pass13.write(let1[each] + let1[each2] + let7[each3] + let1[each4])
					pass13.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let7)):
			for each3 in range(len(let1)):
				for each4 in range(len(let1)):
					pass13.write(let1[each] + let7[each2] + let1[each3] + let1[each4])
					pass13.write("\n")
...
def seqvarslower9():
	...
	# ------- lowercase 9 ---------------------------------------------------------------
	for each in range(len(let9)):
		pass7.write(let9[each])
		pass7.write("\n")

	# -----	lowercase 8-------------------------------------------------------------------
	for each in range(len(let1)):
		for each2 in range(len(let8)):
			pass7.write(let1[each] + let8[each2])
			pass7.write("\n")
	for each in range(len(let8)):
		for each2 in range(len(let1)):
			pass7.write(let8[each] + let1[each2])
			pass7.write("\n")
	# -----	lowercase 7 ----------------------------------------------------------------------
	for each in range(len(let2)):
		for each2 in range(len(let7)):
			pass7.write(let2[each] + let7[each2])
			pass7.write("\n")
	for each in range(len(let7)):
		for each2 in range(len(let2)):
			pass7.write(let7[each] + let2[each2])
			pass7.write("\n")
	for each in range(len(let7)):
		for each2 in range(len(let1)):
			for each3 in range(len(let1)):
				pass7.write(let7[each] + let1[each2] + let1[each3])
				pass7.write("\n")	
	for each in range(len(let1)):
		for each2 in range(len(let1)):
			for each3 in range(len(let7)):
				pass7.write(let1[each] + let1[each2] + let7[each3])
				pass7.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let7)):
			for each3 in range(len(let1)):
				pass7.write(let1[each] + let7[each2] + let1[each3])
				pass7.write("\n")
	...
	for each in range(len(let6)):
		for each2 in range(len(let1)):
			for each3 in range(len(let2)):
				pass7.write(let6[each] + let1[each2] + let2[each3])
				pass7.write("\n")	
	for each in range(len(let6)):
		for each2 in range(len(let2)):
			for each3 in range(len(let1)):
				pass7.write(let6[each] + let2[each2] + let1[each3])
				pass7.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let6)):
			for each3 in range(len(let2)):
				pass7.write(let1[each] + let6[each2] + let2[each3])
				pass7.write("\n")
	for each in range(len(let2)):
		for each2 in range(len(let6)):
			for each3 in range(len(let1)):
				pass7.write(let2[each] + let6[each2] + let1[each3])
				pass7.write("\n")	
	for each in range(len(let1)):
		for each2 in range(len(let2)):
			for each3 in range(len(let6)):
				pass7.write(let1[each] + let2[each2] + let6[each3])
				pass7.write("\n")
	for each in range(len(let2)):
		for each2 in range(len(let1)):
			for each3 in range(len(let6)):
				pass7.write(let2[each] + let1[each2] + let6[each3])
				pass7.write("\n")
	for each in range(len(let6)):
		for each2 in range(len(let3)):
				pass7.write(let6[each] + let3[each2])
				pass7.write("\n")
	for each in range(len(let3)):
		for each2 in range(len(let6)):
				pass7.write(let3[each] + let6[each2])
				pass7.write("\n")
	...
	for each in range(len(let5)):
		for each2 in range(len(let2)):
			for each3 in range(len(let2)):
				pass7.write(let5[each] + let2[each2] + let2[each3])
				pass7.write("\n")	
	for each in range(len(let2)):
		for each2 in range(len(let5)):
			for each3 in range(len(let2)):
				pass7.write(let2[each] + let5[each2] + let2[each3])
				pass7.write("\n")
	for each in range(len(let2)):
		for each2 in range(len(let2)):
			for each3 in range(len(let5)):
				pass7.write(let2[each] + let2[each2] + let5[each3])
				pass7.write("\n")
	for each in range(len(let5)):
		for each2 in range(len(let3)):
			for each3 in range(len(let1)):
				pass7.write(let5[each] + let3[each2] + let1[each3])
				pass7.write("\n")	
	for each in range(len(let5)):
		for each2 in range(len(let1)):
			for each3 in range(len(let3)):
				pass7.write(let5[each] + let1[each2] + let3[each3])
				pass7.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let5)):
			for each3 in range(len(let3)):
				pass7.write(let1[each] + let5[each2] + let3[each3])
				pass7.write("\n")
	for each in range(len(let3)):
		for each2 in range(len(let5)):
			for each3 in range(len(let1)):
				pass8.write(let3[each] + let5[each2] + let1[each3])
				pass8.write("\n")	
	for each in range(len(let1)):
		for each2 in range(len(let3)):
			for each3 in range(len(let5)):
				pass8.write(let1[each] + let3[each2] + let5[each3])
				pass8.write("\n")
	for each in range(len(let3)):
		for each2 in range(len(let1)):
			for each3 in range(len(let5)):
				pass8.write(let3[each] + let1[each2] + let5[each3])
				pass8.write("\n")
	
	# ------------lowercase 4 ----------------------------------------------------------------
	for each in range(len(let5)):
		for each2 in range(len(let4)):
					pass8.write(let5[each] + let4[each2])
					pass8.write("\n")
	for each in range(len(let4)):
		for each2 in range(len(let5)):
					pass8.write(let4[each] + let5[each2])
					pass8.write("\n")
	for each in range(len(let4)):
		for each2 in range(len(let4)):
			for each3 in range(len(let1)):
					pass8.write(let4[each] + let4[each2] + let1[each3])
					pass8.write("\n")
	for each in range(len(let4)):
		for each2 in range(len(let1)):
			for each3 in range(len(let4)):
					pass8.write(let4[each] + let1[each2] + let4[each3])
					pass8.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let4)):
			for each3 in range(len(let4)):
					pass9.write(let1[each] + let4[each2] + let4[each3])
					pass9.write("\n")
...
# ------------lowercase 4 ----------------------------------------------------------------
	...
	for each in range(len(let1)):
		for each2 in range(len(let4)):
			for each3 in range(len(let4)):
					pass12.write(let1[each].capitalize() + let4[each2] + let4[each3])
					pass12.write("\n")
	
	for each in range(len(let2)):
		for each2 in range(len(let3)):
			for each3 in range(len(let4)):
				pass12.write(let2[each].capitalize() + let3[each2] + let4[each3])
				pass12.write("\n")
...
def seqvarslower8():
	...
	for each in range(len(let2)):
		for each2 in range(len(let3)):
			for each3 in range(len(let3)):
				pass2.write(let2[each] + let3[each2] + let3[each3])
				pass2.write("\n")
	for each in range(len(let3)):
		for each2 in range(len(let2)):
			for each3 in range(len(let3)):
				pass2.write(let3[each] + let2[each2] + let3[each3])
				pass2.write("\n")
	for each in range(len(let3)):
		for each2 in range(len(let3)):
			for each3 in range(len(let2)):
				pass2.write(let3[each] + let3[each2] + let2[each3])
				pass2.write("\n")
...
def seqvarsCap8():
	...
	# -------------	lowercase 8 --------------------------------------------------------
	for each in range(len(let8)):
		pass4.write(let8[each].capitalize())
		pass4.write("\n")	

	# -----	lowercase 7-------------------------------------------------------------------
	for each in range(len(let1)):
		for each2 in range(len(let7)):
			pass4.write(let1[each].capitalize() + let7[each2])
			pass4.write("\n")

	for each in range(len(let7)):
		for each2 in range(len(let1)):
			pass4.write(let7[each].capitalize() + let1[each2])
			pass4.write("\n")
	
	# -----	lowercase 6 ----------------------------------------------------------------------
	for each in range(len(let2)):
		for each2 in range(len(let6)):
			pass4.write(let2[each].capitalize() + let6[each2])
			pass4.write("\n")
	for each in range(len(let6)):
		for each2 in range(len(let2)):
			pass4.write(let6[each].capitalize() + let2[each2])
			pass4.write("\n")
	for each in range(len(let6)):
		for each2 in range(len(let1)):
			for each3 in range(len(let1)):
				pass4.write(let6[each].capitalize() + let1[each2] + let1[each3])	
				pass4.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let1)):
			for each3 in range(len(let6)):
				pass4.write(let1[each].capitalize() + let1[each2] + let6[each3])
				pass4.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let6)):
			for each3 in range(len(let1)):
				pass4.write(let1[each].capitalize() + let6[each2] + let1[each3])
				pass4.write("\n")

	# -----	lowercase 5 ------------------------------------------------------------------------------------------
	for each in range(len(let5)):
		for each2 in range(len(let3)):
			pass4.write(let5[each].capitalize() + let3[each2])
			pass4.write("\n")
	for each in range(len(let3)):
		for each2 in range(len(let5)):
			pass4.write(let3[each].capitalize() + let5[each2])
			pass4.write("\n")
	for each in range(len(let5)):
		for each2 in range(len(let1)):
			for each3 in range(len(let2)):
				pass4.write(let5[each].capitalize() + let1[each2] + let2[each3])
				pass4.write("\n")
	for each in range(len(let5)):
		for each2 in range(len(let2)):
			for each3 in range(len(let1)):
				pass4.write(let5[each].capitalize() + let2[each2] + let1[each3])
				pass4.write("\n")
	for each in range(len(let5)):
		for each2 in range(len(let1)):
			for each3 in range(len(let1)):
				for each4 in range(len(let1)):
					pass4.write(let5[each].capitalize() + let1[each2] + let1[each3] + let1[each4])
					pass4.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let1)):
			for each3 in range(len(let1)):
				for each4 in range(len(let5)):
					pass4.write(let1[each].capitalize() + let1[each2] + let1[each3] + let5[each4])
					pass4.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let5)):
			for each3 in range(len(let1)):
				for each4 in range(len(let1)):
					pass4.write(let1[each].capitalize() + let5[each2] + let1[each3] + let1[each4])
					pass4.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let1)):
			for each3 in range(len(let5)):
				for each4 in range(len(let1)):
					pass4.write(let1[each].capitalize() + let1[each2] + let5[each3] + let1[each4])
					pass4.write("\n")
	for each in range(len(let2)):
		for each2 in range(len(let1)):
			for each3 in range(len(let5)):
				pass4.write(let2[each].capitalize() + let1[each2] + let5[each3])
				pass4.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let5)):
			for each3 in range(len(let2)):
				pass4.write(let1[each].capitalize() + let5[each2] + let2[each3])
				pass4.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let2)):
			for each3 in range(len(let5)):
				pass4.write(let1[each].capitalize() + let2[each2] + let5[each3])
				pass4.write("\n")
	for each in range(len(let2)):
		for each2 in range(len(let5)):
			for each3 in range(len(let1)):
				pass4.write(let2[each].capitalize() + let5[each2] + let1[each3])
				pass4.write("\n")
	...
	for each in range(len(let4)):
		for each2 in range(len(let2)):
			for each3 in range(len(let2)):
				pass4.write(let4[each].capitalize() + let2[each2] + let2[each3])
				pass4.write("\n")
	for each in range(len(let4)):
		for each2 in range(len(let1)):
			for each3 in range(len(let3)):
				pass4.write(let4[each].capitalize() + let1[each2] + let3[each3])	
				pass4.write("\n")
	for each in range(len(let4)):
		for each2 in range(len(let3)):
			for each3 in range(len(let1)):
				pass4.write(let4[each].capitalize() + let3[each2] + let1[each3])
				pass4.write("\n")		
	for each in range(len(let1)):
		for each2 in range(len(let4)):
			for each3 in range(len(let3)):
				pass4.write(let1[each].capitalize() + let4[each2] + let3[each3])
				pass4.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let3)):
			for each3 in range(len(let4)):
				pass4.write(let1[each].capitalize() + let3[each2] + let4[each3])
				pass4.write("\n")
	for each in range(len(let3)):
		for each2 in range(len(let1)):
			for each3 in range(len(let4)):
				pass4.write(let3[each].capitalize() + let1[each2] + let4[each3])
				pass4.write("\n")
	for each in range(len(let3)):
		for each2 in range(len(let4)):
			for each3 in range(len(let1)):
				pass4.write(let3[each].capitalize() + let4[each2] + let1[each3])
				pass4.write("\n")
	for each in range(len(let2)):
		for each2 in range(len(let4)):
			for each3 in range(len(let2)):
				pass4.write(let2[each].capitalize() + let4[each2] + let2[each3])
				pass4.write("\n")
	for each in range(len(let2)):
		for each2 in range(len(let2)):
			for each3 in range(len(let4)):
				pass4.write(let2[each].capitalize() + let2[each2] + let4[each3])
				pass4.write("\n")
	for each in range(len(let4)):
		for each2 in range(len(let4)):
			pass4.write(let4[each].capitalize() + let4[each2])
			pass4.write("\n")
	...
	for each in range(len(let2)):
		for each2 in range(len(let3)):
			for each3 in range(len(let3)):
				pass4.write(let2[each].capitalize() + let3[each2] + let3[each3])
				pass4.write("\n")
	for each in range(len(let3)):
		for each2 in range(len(let2)):
			for each3 in range(len(let3)):
				pass4.write(let3[each].capitalize() + let2[each2] + let3[each3])
				pass4.write("\n")
	for each in range(len(let3)):
		for each2 in range(len(let3)):
			for each3 in range(len(let2)):
				pass4.write(let3[each].capitalize() + let3[each2] + let2[each3])
				pass4.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let2)):
			for each3 in range(len(let2)):
				for each4 in range(len(let3)):
					pass4.write(let1[each].capitalize() + let2[each2] + let2[each3] + let3[each4])
					pass4.write("\n")
	for each in range(len(let2)):
		for each2 in range(len(let1)):
			for each3 in range(len(let2)):
				for each4 in range(len(let3)):
					pass4.write(let2[each].capitalize() + let1[each2] + let2[each3] + let3[each4])
					pass4.write("\n")
	for each in range(len(let2)):
		for each2 in range(len(let2)):
			for each3 in range(len(let1)):
				for each4 in range(len(let3)):
					pass5.write(let2[each].capitalize() + let2[each2] + let1[each3] + let3[each4])
					pass5.write("\n")
	for each in range(len(let2)):
		for each2 in range(len(let2)):
			for each3 in range(len(let3)):
				for each4 in range(len(let1)):
					pass5.write(let2[each].capitalize() + let2[each2] + let3[each3] + let1[each4])
					pass5.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let3)):
			for each3 in range(len(let2)):
				for each4 in range(len(let2)):
					pass5.write(let1[each].capitalize() + let3[each2] + let2[each3] + let2[each4])
					pass5.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let2)):
			for each3 in range(len(let3)):
				for each4 in range(len(let2)):
					pass5.write(let1[each].capitalize() + let2[each2] + let3[each3] + let2[each4])
					pass5.write("\n")
	for each in range(len(let3)):
		for each2 in range(len(let1)):
			for each3 in range(len(let2)):
				for each4 in range(len(let2)):
					pass5.write(let3[each].capitalize() + let1[each2] + let2[each3] + let2[each4])
					pass5.write("\n")
	for each in range(len(let3)):
		for each2 in range(len(let2)):
			for each3 in range(len(let1)):
				for each4 in range(len(let2)):
					pass5.write(let3[each].capitalize() + let2[each2] + let1[each3] + let2[each4])
					pass5.write("\n")
	for each in range(len(let3)):
		for each2 in range(len(let2)):
			for each3 in range(len(let2)):
				for each4 in range(len(let1)):
					pass5.write(let3[each].capitalize() + let2[each2] + let2[each3] + let1[each4])
					pass5.write("\n")
	for each in range(len(let2)):
		for each2 in range(len(let1)):
			for each3 in range(len(let3)):
				for each4 in range(len(let2)):
					pass5.write(let2[each].capitalize() + let1[each2] + let3[each3] + let2[each4])
					pass5.write("\n")
	for each in range(len(let2)):
		for each2 in range(len(let3)):
			for each3 in range(len(let1)):
				for each4 in range(len(let2)):
					pass5.write(let2[each].capitalize() + let3[each2] + let1[each3] + let2[each4])
					pass5.write("\n")
	for each in range(len(let2)):
		for each2 in range(len(let3)):
			for each3 in range(len(let2)):
				for each4 in range(len(let1)):
					pass5.write(let2[each].capitalize() + let3[each2] + let2[each3] + let1[each4])
					pass5.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let1)):
			for each3 in range(len(let3)):
				for each4 in range(len(let3)):
					pass6.write(let1[each].capitalize() + let1[each2] + let3[each3] + let3[each4])
					pass6.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let3)):
			for each3 in range(len(let1)):
				for each4 in range(len(let3)):
					pass6.write(let1[each].capitalize() + let3[each2] + let1[each3] + let3[each4])
					pass6.write("\n")
	for each in range(len(let1)):
		for each2 in range(len(let3)):
			for each3 in range(len(let3)):
				for each4 in range(len(let1)):
					pass6.write(let1[each].capitalize() + let3[each2] + let3[each3] + let1[each4])
					pass6.write("\n")
	for each in range(len(let3)):
		for each2 in range(len(let3)):
			for each3 in range(len(let1)):
				for each4 in range(len(let1)):
					pass6.write(let3[each].capitalize() + let3[each2] + let1[each3] + let1[each4])
					pass6.write("\n")
	for each in range(len(let3)):
		for each2 in range(len(let1)):
			for each3 in range(len(let3)):
				for each4 in range(len(let1)):
					pass6.write(let3[each].capitalize() + let1[each2] + let3[each3] + let1[each4])
					pass6.write("\n")
	for each in range(len(let3)):
		for each2 in range(len(let1)):
			for each3 in range(len(let1)):
				for each4 in range(len(let3)):
					pass6.write(let3[each].capitalize() + let1[each2] + let1[each3] + let3[each4])
					pass6.write("\n")
