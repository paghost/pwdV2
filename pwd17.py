...
pass8 = open('done/lower84nums.txt', "w")
...
# Sequence Variables lowercase 8 plus 4 nums character
def seqvarslower8plus4nums():
	
	print ('\n')
	print ('Sequencing Variables Lowercase 8 plus 4 nums Character')
	print ('\n')
	
	nums4 = {1776, 1856, 1878}
	...
	for each2 in range(1880, 2026):  # Loop from 1880 to 2025
		for each in range(len(let4)):
			pass8.write(let4[each] + str(each2))
			pass8.write("\n")
			pass8.write(str(each2) + let4[each])
			pass8.write("\n")
